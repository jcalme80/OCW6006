...
class PriorityQueue:
    ...
    def append(self, key):
        ...
        #Parent of node has index = 1/2 of child (if even) or 1/2 of child +1 (if odd)
        newIndex=self.queue.__len__()-1
        ...
        while self.queue[newIndex] < self.queue[parentIndex]:
    ...
    def min_heapify(self,index):
        ...
        if (n+1)*2 < self.__len__():
            l=(n+1)*2-1
        if (n+1)*2+1 < self.__len__():
            r=(n+1)*2
